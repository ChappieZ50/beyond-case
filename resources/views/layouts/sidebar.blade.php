<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{route('dashboard')}}" target="_blank">
            ...
            <span class="ms-1 font-weight-bold">Beyond CASE</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            @if(auth()->user()->is_admin)
                ...
                <li class="nav-item">
                    <a class="nav-link  {{request()->routeIs('answer.*') ? 'active' : ''}}" href="{{route('answer.index')}}">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            @else
                @if(auth()->user()->status)
                    <li class="nav-item">
                        <a class="nav-link  {{request()->routeIs('record.*') ? 'active' : ''}}" href="{{route('record.index')}}">
                            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <title>Record</title>
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
